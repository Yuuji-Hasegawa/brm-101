...
<p class="c-prg-l u-mb-l">
  大変申し訳ございませんが、お探しのページ(<?php echo esc_url($protocol. $_SERVER["HTTP_HOST"].$_SERVER["REQUEST_URI"]); ?>)は見つかりませんでした。<br />
  アドレスバーに直接URLを入力された場合は、アドレスが正しく入力されているか、もう一度ご確認下さい。
</p>
<p class="c-prg-l u-mb-l">
  正しいアドレスを入力しても表示されない場合は、一時的にアクセスできない状況にあるか、移動もしくは削除された可能性があります。<br />
  その場合お手数ですが、トップページからお求めのページを再度お探しください。
</p>
<a class="o-bx c-btn c-btn--tnl c-prg-l u-px-m u-py-s u-dsp-ibc u-brd-r-s" href="<?php echo home_url('/');?>">
  ...
  </svg><span class="u-flx-shn">トップページへ戻る</span>
</a>
<?php get_footer();?>
