...
<div class="c-gnd">
  <?php if(!is_front_page()) {
	...
	<div class="o-ctr u-ctr u-space-clamp c-cta u-py-2xl">
		<h2 class="o-stc u-ins-stc u-space-s u-txt-ctr u-mb-m">
			<span class="c-h2-ext u-fnt-wb">お問い合わせ</span>
			<span class="c-prg-l u-fnt-wm">ご相談・ご質問は、こちらからお気軽にお問い合わせください。</span>
		</h2>
    <?php
      if ($tel = get_vars('contact.tel')):
    ?>
		  <div class="o-stc u-ins-stc u-space-s u-txt-ctr u-mb-m">
        <a href="<?php echo esc_url('tel:' . $tel); ?>" class="c-h1-ext c-cta-link u-dsp-flx u-flx-y-b u-mw-cnt u-mx-auto">
          <!-- prettier-ignore -->
          <svg class="o-icn u-mr-m" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
          ...
          <span class="u-fnt-en u-fnt-wb u-flx-shn"><?php echo esc_html($tel); ?></span>
        </a>
        <?php
        ...
        ?>
          <span class="c-sml-l">
            営業時間<?php
              if ($workday) echo '&nbsp;' . esc_html($workday);
              if ($timeRange) echo '&nbsp;' . $timeRange;
            ?>
          </span>
        <?php endif;?>
		  </div>
    <?php endif;?>
		...
		>
			<!-- prettier-ignore -->
			<svg class="u-mr-s" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
				<!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
				<path d="M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4L236.8 313.6c11.4 8.5 27 8.5 38.4 0L492.8 150.4c12.1-9.1 19.2-23.3 19.2-38.4c0-26.5-21.5-48-48-48H48zM0 176V384c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V176L294.4 339.2c-22.8 17.1-54 17.1-76.8 0L0 176z" fill="currentColor"></path>
			</svg>
			メールでお問い合わせ
		</a>
	</div>
	<footer class="o-ctr u-ins-ctr u-space-clamp u-py-2xl u-bg-neu">
		<div class="o-sdb u-mb-m">
			<div class="o-stc u-ins-stc u-space-m c-fld-fit">
				<ul class="o-cls">
					<li>
            <a
              class="c-hd-link c-prg-l u-fnt-wb u-hit-exp"
            ...
            >
              お問い合わせ
				...
				<ul class="o-cls">
					<li>
            <a
              class="c-hd-link c-prg-m u-fnt-wm u-hit-exp"
				...
				<ul class="o-cls">
					<li>
						<a
							...
							href="<?php echo esc_url(get_vars('sns.fb') ?: '#'); ?>"
					...
					<li>
						<a
							class="c-hd-link c-h1-ext u-dsp-flx u-pd-xs j-cnt-auto"
							href="<?php echo esc_url(get_vars('sns.tw') ?: '#'); ?>"
							aria-label="Twitterへ"
							title="Twitter"
							rel="noopener noreferrer"
							target="_blank"
					...
					<li>
						<a
							class="c-hd-link c-h1-ext u-dsp-flx u-pd-xs j-cnt-auto"
							href="<?php echo esc_url(get_vars('sns.instagram') ?: '#'); ?>"
      ...
      <?php $siteName = esc_html(get_vars('site.name') ?: '#');?>
			<a
				class="c-logo c-logo--ft u-dsp-ifx u-mw-cnt"
				href="<?php echo home_url('/');?>"
				aria-label="<?php echo $siteName;?>のトップページへ"
				title="<?php echo $siteName;?>"
			>
				<!-- prettier-ignore -->
				<svg viewBox="0 0 1131 239" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<path d="M99.5625 238.996L149.343 159.318L199.123 238.996H99.5625Z" fill="#92CAEF"/>
					<path d="M0 238.994L49.7805 159.322L99.5608 239L0 238.994Z" fill="#7EBAE6"/>
					<path d="M398.249 79.6719L348.469 159.324L298.682 79.6719H398.249Z" fill="#85C1EB"/>
					<path d="M248.901 159.324L298.675 79.6719L348.449 159.324H248.901Z" fill="#7EBAE6"/>
					<path d="M298.682 79.6719L248.902 159.324L199.122 79.6719H298.682Z" fill="#7BB8E5"/>
					<path d="M149.342 159.324L199.123 79.6719L248.891 159.324H149.342Z" fill="#85C1EB"/>
					<path d="M199.123 79.6719L149.343 159.324L99.5625 79.6719H199.123Z" fill="#73B2E2"/>
					<path d="M49.7822 159.324L99.5626 79.6719L149.331 159.324H49.7822Z" fill="#67A0D3"/>
					...
					<path d="M99.5625 79.671L149.343 0L199.123 79.677L99.5625 79.671Z" fill="#73B2E2"/>
					<path d="M149.331 0L99.5626 79.671L49.7822 0H149.331Z" fill="#65A5DA"/>
				</svg>
