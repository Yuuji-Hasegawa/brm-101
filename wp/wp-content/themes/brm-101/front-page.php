...
<div class="c-msk">
    ...
    <picture class="o-frm u-asp-rt-l j-cnt-auto">
      <source
				type="image/avif"
				srcset="<?php echo get_template_directory_uri();?>/img/hero-320.avif   320w,
                <?php echo get_template_directory_uri();?>/img/hero-640.avif   640w,
                <?php echo get_template_directory_uri();?>/img/hero-960.avif   960w,
                <?php echo get_template_directory_uri();?>/img/hero-1920.avif 1920w,
                <?php echo get_template_directory_uri();?>/img/hero.avif      1921w"
      ...
      <source
				type="image/webp"
				srcset="<?php echo get_template_directory_uri();?>/img/hero-320.webp   320w,
                <?php echo get_template_directory_uri();?>/img/hero-640.webp   640w,
                <?php echo get_template_directory_uri();?>/img/hero-960.webp   960w,
                <?php echo get_template_directory_uri();?>/img/hero-1920.webp 1920w,
                <?php echo get_template_directory_uri();?>/img/hero.webp      1921w"
				sizes="(max-width: 320px) 320px,
							 (max-width: 640px) 640px,
							 (max-width: 960px) 960px,
							 (max-width: 1920px) 1920px,
      ...
      <img
				...
				srcset="<?php echo get_template_directory_uri();?>/img/hero-320.png   320w,
                <?php echo get_template_directory_uri();?>/img/hero-640.png   640w,
                <?php echo get_template_directory_uri();?>/img/hero-960.png   960w,
                <?php echo get_template_directory_uri();?>/img/hero-1920.png 1920w,
                <?php echo get_template_directory_uri();?>/img/hero.png      1921w"
				sizes="(max-width: 320px) 320px,
							 (max-width: 640px) 640px,
							 (max-width: 960px) 960px,
							 (max-width: 1920px) 1920px,
	...
	<div class="o-cvr c-msk__surf c-msk__surf--hero">
		<h1 class="o-stc u-mg-auto u-txt-ctr">
			<span class="c-h2-ext u-fnt-wb u-mb-m u-tlv-m">
				ビジネスをもっと青く
			</span>
			<span class="c-h1-ext u-dsp-ifx u-dlv-m">
        <!-- prettier-ignore -->
				<svg viewBox="0 0 688 87" fill="none" xmlns="http://www.w3.org/2000/svg">
			  ...
			  <span class="sr-only"><?php echo get_vars('site.name');?></span>
			</span>
		</h1>
  </div>
</div>
<div class="o-ctr u-ins-ctr u-space-clamp u-py-2xl u-bg-neu">
	<h2 class="c-h2-ext u-mb-l u-txt-ctr u-fnt-en u-fnt-wb">Information</h2>
	<?php echo get_front_news();?>
</div>
<div class="o-ctr u-ins-ctr u-space-clamp u-py-2xl">
	<h2 class="c-h2-ext u-mb-l u-txt-ctr u-fnt-wb u-fnt-en">
		What's New
	</h2>
  <?php if (have_posts()):?>
    <ul class="o-grd o-grd--t u-mb-xl">
  ...
  <?php else:?>
    <p class="c-prg-l u-mx-auto u-mw-r">記事はまだありません。</p>
  <?php endif;?>
	<a
		class="o-bx c-btn c-btn--fll c-prg-l u-fnt-wb u-brd-r-s u-dsp-flx u-mx-auto u-mw-cnt u-flx-y-ctr u-py-s u-px-m"
