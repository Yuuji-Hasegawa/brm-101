        ...
        if (count($elements) >= 1) {
            ...
            foreach ($elements as $element) {
                ...
                while ($currentlevel < $level) {
                    if ($currentlevel === 0) {
                        $output .= '<ul class="c-ul u-pb-m u-pr-m">';
                    } else {
                        $output .= '<ul class="c-ul">';
                    }
                    $currentlevel++;
                }
                while ($currentlevel > $level) {
                ...
                $output .= '<li><a href="#' . $id . '" class="c-a c-a--und u-dsp-blc u-py-s">' . strip_tags($element[2]) . '</a>';
                $i++;
                $id =  'chapter-' . $i;
            }
            ...
            $index = '<details class="o-bx c-toc u-mb-l">
