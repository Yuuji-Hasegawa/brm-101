...
<p class="c-prg-l">
	本サイト規約（以下「本規約」と言います。）には、本サイトの利用条件及び当社とユーザーの皆様との間の権利義務関係が定められています。<br />
...
<dl class="o-stc u-mb-xl">
	...
	<dd class="c-prg-l">
		...
		<ol class="c-ol c-ol--alt">
			...
			<li>
				「当社」とは、「<?php echo esc_html(get_vars('legal.company') ?: '#');?>」を意味します。
			</li>
			<li>
				「当社ウェブサイト」とは、そのドメインが「<?php echo esc_html(get_vars('legal.domain') ?: 'examples.com');?>」である、当社が運営するウェブサイト（理由の如何を問わず、当社のウェブサイトのドメインまたは内容が変更された場合は、当該変更後のウェブサイトを含みます。）を意味します。
			</li>
			<li>
				「ユーザー」とは、本サイトの利用者として情報の閲覧を行う個人または法人を意味します。
			</li>
			<li>
				「本サイト」とは、当社が提供する「<?php echo esc_html(get_vars('legal.serviceName') ?: '#');?>」という名称のウェブサイト（理由の如何を問わずウェブサイトの名称または内容が変更された場合は、当該変更後のウェブサイトを含みます。）を意味します。
			</li>
		</ol>
	</dd>
	<dt class="c-h2 u-txt-ctr">
		...
		<ol class="c-ol c-ol--alt">
			...
			<li>
				...
				<ul class="c-ul">
					...
					<li>
						当社、本サイトの他の利用者またはその他の第三者の名誉または信用を毀損する表現を含む情報
					</li>
					<li>
						過度にわいせつな表現を含む情報
					</li>
			...
			<li>
				当社ウェブサイト上で掲載する本サイト利用に関するルール(<a
				class="c-a c-a--und"
				target="_blank"
				rel="noopener noreferrer"
				href="<?php echo home_url('/terms/');?>"
				>
					<?php echo home_url('/terms/');?>
				</a>)に抵触する行為
			</li>
			<li>
				反社会的勢力等への利益供与
	...
	<dd class="c-prg-l">
		<ol class="c-ol">
			...
			<li>
				当社は、本サイトに関してユーザーが被った損害につき、過去<?php echo esc_html(get_vars('legal.payterm') ?: '6ヶ月間');?>にユーザーが当社に支払った対価の金額を超えて賠償する責任を負わないものとし、また、付随的損害、間接損害、特別損害、将来の損害及び逸失利益にかかる損害については、賠償する責任を負わないものとします。
			</li>
			<li>
	...
	<dd class="c-prg-l">
		<ol class="c-ol">
			<li>
				当社によるユーザーの利用者情報の取扱いについては、別途当社プライバシーポリシー(<a
				class="c-a"
				target="_blank"
				rel="noopener noreferrer"
				href="<?php echo home_url('/privacy-policy/');?>"><?php echo home_url('/privacy-policy/');?></a>)の定めによるものとし、ユーザーはこのプライバシーポリシーに従って当社がユーザーの利用者情報を取扱うことについて同意するものとします。
			</li>
			<li>
	...
	<dd class="c-prg-l">
		<ol class="c-ol">
			<li>
				本規約及びサイト利用契約の準拠法は日本法とします。
			</li>
			<li>
				本規約またはサイト利用契約に起因し、または関連する一切の紛争については、<?php echo esc_html(get_vars('legal.court') ?: '東京地方裁判所')?>を第一審の専属的合意管轄裁判所とします。
			</li>
		</ol>
	</dd>
</dl>
